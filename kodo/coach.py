...
class StructuredCoach(Coach):
    """Coach variant using structured output instead of tool calls."""
    ...
    def _do_assess(self) -> None:
        ...
        try:
            ...
            self._queue.push(fb.feedback, source="coach", priority=fb.priority)
        except Exception as exc:
            log.emit("coach_assess_error", error=str(exc))
