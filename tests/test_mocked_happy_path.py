...
def _mocked_patches():
    ...
    return (
        patch(
            ...
            autospec=True,
            side_effect=_fake_make_session,
        ),
        patch(
            "kodo.factory.make_session", autospec=True, side_effect=_fake_make_session
        ),
        ...
        patch(
            "kodo.factory._build_team_quick",
            autospec=True,
            side_effect=_fake_build_team,
        ),
        patch(
            "kodo.factory._build_team_full", autospec=True, side_effect=_fake_build_team
        ),
        patch(
        ...
        patch(
            "kodo.cli._launch.preflight_check_backends", autospec=True, return_value=[]
        ),
    )
...
class TestReleaseChecklistSmokeScripts:
    ...
    def test_interactive_smoke_script_completes(self):
        """The interactive smoke script is mocked and needs no real backends."""
    ...
    def test_oserror_on_goal_md_falls_back_to_get_goal(self, tmp_path: Path):
        ...
        with (
            ...
            patch(
                ...
                autospec=True,
                return_value="Fallback goal from get_goal",
            ),
            patch(
